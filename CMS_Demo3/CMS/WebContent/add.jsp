			...
			<div class="row">
			    ...
			    <div class="col-md-5" style="text-align:center;padding-top:25px;">
			    	    <div class="row">
			    	    	...
			    	    	<h4 class="col-md-6"><i class="icon icon-plus"></i>Add New Customer</h4>
			    	    </div>
			    	    <br />
						<form id="add_form" action="<c:url value='/CustomerServlet' />" method="post"  class="form-horizontal form">
