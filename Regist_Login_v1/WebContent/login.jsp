...
<html>
	...
	<body>
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h3 class="text-center"><i class="icon-user"></i>用户登录</h3>
					<hr style="width:36%;" />
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<form action="LoginServlet" method="post" class="form-horizontal" role="form">
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" value="${user.username }" name="username" placeholder="请输入用户名" />
							</div>
							<div class="col-sm-4">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control"  value="${user.verifyCode }" name="verifyCode" placeholder="请输入验证码" />
							</div>
							<div class="col-sm-4">
